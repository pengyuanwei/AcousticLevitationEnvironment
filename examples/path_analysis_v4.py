...
# Modified based on the path_analysis_v2.py: 分析轨迹frame之间的加速度变化，以及对应的Gorkov

if __name__ == '__main__':
    n_particles = 8
    global_model_dir_1 = './experiments/experiment_20'
    model_name = '20_19_98_99/planner_v7'
    num_file = 30
    ...
    for n in range(10):
        ...
        gorkov_TWGS = levitator_TWGS.calculate_gorkov(paths)
        gorkov_WGS = levitator_WGS.calculate_gorkov(paths)
        # 可视化速度
        visualize_all_particles_v2(accumulative_time, gorkov_TWGS.T, gorkov_WGS.T)