...
# Modified based on the path_smoothing_s_curve_v_v5.py: 根据sum max a, 以及max a优化
...
if __name__ == '__main__':
    ...
    for n in range(num_file):
        ...
        if np.all(delta_v[min_index_1] < 0.0):
            ...
            if min_index_1[1] != min_index_2[1] and np.sum(delta_v[min_index_2]) < 0.0:
