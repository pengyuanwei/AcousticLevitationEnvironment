...
# Modified based on the kinodynamics_analysis_9.py: 任意初始速度的S曲线速度计算，没有最大速度约束
# 此处不可解。如果要满足所有速度大于0，震荡会随着时间越来越大。
...
if __name__ == '__main__':
    ...
    for n in range(num_file):
        ...
        for i in range(split_data.shape[1]-1):
            sub_t, sub_accelerations, sub_velocities, sub_trajectories = smooth_trajectories_arbitrary_initial_velocity_v2(
